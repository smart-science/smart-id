...
- README documents the algorithm, error detection, strict type guards, error code trigger conditions, and runtime support.
...
- engines.node narrowed to ^20.19.0 || >=22.12.0, where require() of the package works; engines.bun raised to >=1.3.0, the oldest version tested in CI.
